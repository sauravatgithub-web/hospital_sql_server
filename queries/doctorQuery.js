...
const getAllDoctorsQuery = tryCatch(async (req, res, next) => {
  ...
  const getDoctorByIdQuery = tryCatch(async (req, res, next) => {
    ...
    return res.status(200).json({ success: true, doctor: populatedDoctor });
  });
